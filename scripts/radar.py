...
# Hogwarts palette: Gryffindor Scarlet primary, Hogwarts Gold secondary
THEMES = {
    "dark": {
        "grid": "#3B0A0A",      # Deep Burgundy — ring lines
        "spoke": "#2a0606",     # darker burgundy — spokes
        "label": "#e6e1d8",     # warm off-white — axis labels
        "value": "#B8B8B8",     # Silver — secondary value text
        "title": "#D3A625",     # Hogwarts Gold — chart title
        "fill": "#AE0001",      # Gryffindor Scarlet — data shape fill
        "stroke": "#CC1010",    # Scarlet lighter — data outline
        "vertex": "#D3A625",    # Hogwarts Gold — vertex dots
        "bg": "none",
    },
    "light": {
        "grid": "#d4b8a0",      # parchment-toned grid
        "spoke": "#e8d4b8",     # light parchment spokes
        "label": "#1a0a00",     # near-black — axis labels
        "value": "#5c3d1e",     # dark brown — value text
        "title": "#AE0001",     # Scarlet — chart title
        "fill": "#AE0001",      # Scarlet — data shape
        "stroke": "#8b0000",    # dark scarlet outline
        "vertex": "#D3A625",    # Gold vertices
        "bg": "none",
    },
}
...
def from_github(user: str, token: str | None, limit: int, exclude: set[str],
    ...
    return f"{user} · WHAT THE REPOS SAY", axes
