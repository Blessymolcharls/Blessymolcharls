...
# Hogwarts palette — Gryffindor Scarlet primary, Hogwarts Gold dim highlights
THEMES = {
    # name: (foreground, dim-foreground, background-or-None)
    "dark":  ("#CC2020", "#3B0A0A", None),   # scarlet bright / deep burgundy dim
    "light": ("#AE0001", "#c47a7a", None),   # scarlet / muted parchment-rose dim
}
