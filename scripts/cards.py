...
# Hogwarts palette: Gryffindor Scarlet primary, Hogwarts Gold accent
THEMES = {
    "dark": {
        "bg": "#0B0B0D",       # Hogwarts Black
        "border": "#3B0A0A",   # Deep Burgundy border
        "title": "#AE0001",    # Gryffindor Scarlet — title / repo name
        "text": "#e6e1d8",     # warm off-white body text
        "muted": "#B8B8B8",    # Silver muted text
        "value": "#D3A625",    # Hogwarts Gold — numbers / values
        "accent": "#AE0001",   # Scarlet accent
    },
    "light": {
        "bg": "#fdf6ec",       # light parchment
        "border": "#d4b8a0",   # parchment border
        "title": "#AE0001",    # Scarlet title
        "text": "#1a0a00",     # near-black text
        "muted": "#5c3d1e",    # dark-brown muted text
        "value": "#8b5e00",    # dark gold values
        "accent": "#AE0001",   # Scarlet accent
    },
}
